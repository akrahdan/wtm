...
@Component({
  selector: 'app-devotion-detail',
  templateUrl: './devotion-detail.component.html',
  styleUrls: ['./devotion-detail.component.css']
})
export class DevotionDetailComponent implements OnInit {

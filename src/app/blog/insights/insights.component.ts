...
export class InsightsComponent implements OnInit {
  ...
  constructor(
    ...
    let urlparams = new URLSearchParams('filter[meta_key]=wps_subtitle&filter[meta_value]=Introduction&per_page=40&_embed');
    let restparams = new URLSearchParams('per_page=16&_embed');

    let heroparams = new URLSearchParams('filter[category_name]=inhero&per_page=1&_embed');

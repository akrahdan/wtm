...
export class FilterComponent implements OnInit{
  ...
  constructor(private wpApiPosts: WpApiPosts, private _tags: WpApiTerms, iconRegistry: MdIconRegistry, sanitizer: DomSanitizer, private _series:SeriesService, private content: ContentService) {
